...
class TestPipelineSection:
    ...
    def test_strategy_unified_invalid_params(self):
        ...
        with pytest.raises(ValueError, match="features: Invalid parameters for unified strategy: \\{'invalid_param'\\}"):
    ...
    def test_strategy_per_group_invalid_params(self):
        ...
        with pytest.raises(ValueError, match="target: Invalid parameters for per_group strategy: \\{'invalid_param'\\}"):
...
class TestPipelineBuilder:
    ...
    def test_build_grouped_pipeline_success(self):
        ...
        builder.target().transforms(["standard_scale"]).strategy("per_group", group_by="gauge_id").columns(["streamflow"])
