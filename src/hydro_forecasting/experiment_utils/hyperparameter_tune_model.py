# File: hyperparameter_tune_model_refactored.py
import gc
import importlib
import logging
...
from .training_runner_refactored import _configure_trainer_core, _finalize_model_hyperparameters, _setup_datamodule_core
...
def hyperparameter_tune_model(
    ...
    def _objective(trial: optuna.Trial) -> float:
        ...
        try:
            ...
            # Directly use model_factory, no need for _instantiate_model_for_trial wrapper if it's simple
            try:
